    ...
    return (
        <>
            <footer className="px-8 py-3 md:px-16 md:py-10 grid grid-cols-1 lg:grid-cols-3 border-t border-sky-900">
                ...
                <div>
                    <div className="flex justify-evenly items-center align-middle mt-12 lg:mt-0">
                        <Link href="/" passHref={true}>
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 fill-sky-800 cursor-pointer" viewBox="0 0 512 512"><path d="M504 256C504 119 393 8 256 8S8 119 8 256c0 123.78 90.69 226.38 209.25 245V327.69h-63V256h63v-54.64c0-62.15 37-96.48 93.67-96.48 27.14 0 55.52 4.84 55.52 4.84v61h-31.28c-30.8 0-40.41 19.12-40.41 38.73V256h68.78l-11 71.69h-57.78V501C413.31 482.38 504 379.78 504 256z" />
                            </svg>
                        </Link>
                        <Link href="/" passHref={true}>
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 fill-sky-800 cursor-pointer" viewBox="0 0 448 512">
                        ...
                        <Link href="/" passHref={true}>
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 cursor-pointer fill-sky-800" viewBox="0 0 448 512">
                ...
                <div className="flex justify-between mt-6 lg:mt-0 lg:justify-start lg:flex-col items-end">
                    <Link href="/" passHref={true} ><span className="text-xl text-sky-900 font-medium mt-3 cursor-pointer"> Home </span></Link>
                    <Link href="/" passHref={true}><span className="text-xl text-sky-900 font-medium mt-3 cursor-pointer">About Us</span></Link>
                    <Link href="/" passHref={true}><span className="text-xl text-sky-900 font-medium mt-3 cursor-pointer">Contact</span></Link>
                </div>
            </footer>
        </>
    )
