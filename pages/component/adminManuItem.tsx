...
const AdminManuItem: React.FC<adminManuProps> = ({ itemName, imgSrc, prise, deleteHAndal, editHandl }) => {
    return (
        <>
                    ...
                    <div className="p-3">
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            <div>
                                ...
                                <button onClick={ deleteHAndal } className="btn btn-primary">Delete</button>  
                            </div>
                        </div>
                    </div>
                </div>
